...
class BaseClass(metaclass=ABCMeta):
    ...
    def perform_transaction(self,data):
        ...
        print("[\033[33m%s\033[0m] Running WED-transition on wid=%d ..." %(self.trname,data['wid']),flush=True)
        try:
            ...
            if got_lock:
                ...
                print("[\033[33m%s\033[0m] Could not get a lock on wid=%d !" %(self.trname,data['wid']),flush=True)
