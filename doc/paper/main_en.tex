...
\\
\indent The WED-SQL framework has been built inside the PostgreSQL~\cite{PSQL} relational database management system, thereby uses SQL language
...
forward of then is a SQL dialect called pgSQL, that is basically SQL with variables and control structures. Also, modules
