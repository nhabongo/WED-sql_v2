...
\\
\indent  O modelo WED-flow\cite{FTPM10,ICWS12}, como uma alternativa aos modelos clássicos, captura não só a dinâmica da interação entre processos
...
implementar as definições do WED-flow, que são a base para o tratamento de exceções e para o controle transacional.  
