...
\\
  Os modelos clássicos para especificação de processos de negócios, dentre eles o WS-BPEL, algebra de processos e redes
...
\\
  O modelo WED-flow, como uma alternativa aos modelos clássicos, captura não só a dinâmica da interação entre processos
...
\\
  Ao utilizar a abordagem WED-flow para modelar um processo de negócio, modificações nos processos são traduzidas em novos
